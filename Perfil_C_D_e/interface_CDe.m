function [] = interface_CDe ()
%formatando interface para perfil I
global f3; % Perfil dobrado
global f4; % monossimétrico
global figura1;
global IHLdsim1;
global IHSdsim1;
global IHSmsim1;
...
set(findobj(gcf,'Tag','radiobutton1'),'Enable','of');
set(findobj(gcf,'Tag','radiobutton2'),'Enable','of');
set(findobj(gcf,'Tag','radiobutton3'),'Enable','on');
set(findobj(gcf,'Tag','radiobutton4'),'Enable','on');
set(findobj(gcf,'Tag','radiobutton5'),'Enable','of');

set(findobj(gcf,'Tag','radiobutton3'),'Value',1); % Perfil de chapa dobrada
set(findobj(gcf,'Tag','radiobutton4'),'Value',1); % Perfil monossimétrico
...
set(findobj(gcf,'Tag','esf5'),'Enable','on');
       ...
       if f3 == 1;
                %monossimétrico
                if f4 == 1;
                    %figura para perfil Ce de chapa dobrada monossimétrico
                    figura1 = imread('Perfil_DCe.JPG');
