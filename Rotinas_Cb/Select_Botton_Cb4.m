function[] =Select_Botton_Cb4()
global Cb_Case;
global Cb1;
% Esta função torna acessíveis (visíveis) os parâmetros utilizados no
% cálculo de Cb quando o caso do botão 4 é acionado.
set(findobj(gcf,'Tag','uipanel6'),'Visible','on');
% Os valores iniciais os momentos nas extremidades da barra, M1 e M2 devem estar
% vazios, pois ainda nao foram fornecidos.
Cb_Case=4;
Cb1=1.32;
set(findobj(gcf,'Tag','text23'),'string','Cb =');
set(findobj(gcf,'Tag','text24'),'string',Cb1);
