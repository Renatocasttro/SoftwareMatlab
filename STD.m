...
% STD MATLAB code for STD.fig
%      STD, by itself, creates a new STD or raises the existing
%      singleton*.
%
%      H = STD returns the handle to a new STD or the handle to
%      the existing singleton*.
%
%      STD('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in STD.M with the given input arguments.
%
%      STD('Property','Value',...) creates a new STD or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before STD_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to STD_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help STD

% Last Modified by GUIDE v2.5 12-Mar-2024 17:08:00

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @STD_OpeningFcn, ...
                   'gui_OutputFcn',  @STD_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before STD is made visible.
function STD_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to STD (see VARARGIN)

% Choose default command line output for STD
...
% UIWAIT makes STD wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = STD_OutputFcn(hObject, eventdata, handles) 
