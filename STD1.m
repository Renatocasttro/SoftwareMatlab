function varargout = STD1(varargin)
% STD1 MATLAB code for STD1.fig
%      STD1, by itself, creates a new STD1 or raises the existing
%      singleton*.
%
%      H = STD1 returns the handle to a new STD1 or the handle to
%      the existing singleton*.
%
%      STD1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in STD1.M with the given input arguments.
%
%      STD1('Property','Value',...) creates a new STD1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before STD1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to STD1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help STD1

% Last Modified by GUIDE v2.5 29-Jul-2024 17:40:14

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @STD1_OpeningFcn, ...
                   'gui_OutputFcn',  @STD1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before STD1 is made visible.
function STD1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to STD1 (see VARARGIN)

% Choose default command line output for STD1
...
% UIWAIT makes STD1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = STD1_OutputFcn(hObject, eventdata, handles) 
...
global pe;
pe = 1; % Perfil I
% como valores de seleção inicial (tão logo o botão seja acinado) apresenta
% as opções Perfil laminado (radiobutton2) e duplamente simétrico
% (raiobutton5). Após seleção do prefil I (botão icon1), o usuário pode
% modificar as configurações através dos botões de seleção.
set(findobj(gcf,'Tag','radiobutton2'),'Value',1); 
set(findobj(gcf,'Tag','radiobutton5'),'Value',1);
Limpar_dados()
formatarinterface(handles);
...
% global AuxT;
pe = 3; % Perfil T
% AuxT=1 % Toda vez que o formulário for selecionada, vai permitir abrir...
       % o formulário de tipo_flex_T() que vai fornecer o valor do...
       % ...parâmetro B.
Limpar_dados()
formatarinterface(handles);
...
global pe;
pe = 8; % perfil CDe
set(findobj(gcf,'Tag','radiobutton3'),'Value',1); 
